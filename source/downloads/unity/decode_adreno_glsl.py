...
if __name__ == '__main__':
	(vs_variables, vs_in_variables, vs_out_variables, vs_codes, vs_defines) = parse("vert.shader", True)
	(fs_variables, fs_in_variables, fs_out_variables, fs_codes, fs_defines) = parse("frag.shader", False)
